;; Exactly the same as coops-primitive-objects
;; Over time modify the file as objects become non-primative
;; The goal is to turn as many primitive objects as possible into real objects

;; This should be loaded before all other class files
